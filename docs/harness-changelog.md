...
| 2026-09-26 | 후속 16~21장 115개 지식을 한영 5쌍에 추가하고 온라인 평가·전체 구조·학습 현황을 통합 | 후속 source batch·44쌍 문서·123개 prompt·탐색·용어·검토 hash | 115/115 추적, 한영 전체 및 독립 검토, 전체 빌드·화면·vault 검증 |
| 2026-09-26 | 반복 반입에서 수동으로만 확인하던 원문 공백 복원 무결성을 자동 검증 | check_handbook·스펙 002 R7·5개 회귀·README·문서 지도 | 같은 길이 본문 변조·손상/중복 metadata red→green, 58개 전체 검사·기존/신규 업로드 복원 PASS |
